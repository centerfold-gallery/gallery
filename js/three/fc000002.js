    ...
    function init() {
        ...
        var momentslogogeometry = new THREE.CubeGeometry(80,40,0);
        var momentslogotexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/featured-collections/FC000002-header.png' );
        ...
        var curatory2texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/curatorial-statement-1.png' );
        ...
        curatory2.position.set(-25,14,-300);
        scene.add( curatory2 );

        var curatory3geometry = new THREE.CubeGeometry(50,50,0);
        var curatory3texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/curatorial-statement-2.png' );
        ...
        curatory3.position.set(25,14,-300);
        scene.add( curatory3 );
        ...
        var art1texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000350-full.jpg' );
        ...
        var art1labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000350-card.png' );
        ...
        var art2texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000353-full.jpg' );
        ...
        var art2labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000353-card.png' );
        ...
        var art3geometry = new THREE.CubeGeometry(40,53,1);
        var art3texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000229-full.jpg' );
        ...
        art3.position.set(-100,24,-650);
        art3.rotation.y = Math.PI / 4;
        scene.add( art3 );

        var art3labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art3labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000229-card.png' );
        ...
        var art4geometry = new THREE.CubeGeometry(40,29,1);
        var art4texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000284-full.jpg' );
        ...
        var art4labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000284-card.png' );
        ...
        var art5geometry = new THREE.CubeGeometry(40,31,1);
        var art5texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000004-full.jpg' );
        ...
        var art5labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000004-card.png' );
        ...
        var art6geometry = new THREE.CubeGeometry(40,50,1);
        var art6texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000323-full.jpg' );
        ...
        art6.position.set(0,22,-950);
        art6.rotation.y = Math.PI / 3.6;
        scene.add( art6 );

        var art6labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art6labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000323-card.png' );
        ...
        var art7geometry = new THREE.CubeGeometry(40,55,1);
        var art7texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000047-full.jpg' );
        ...
        art7.position.set(70,24.8,-1050);
        art7.rotation.y = Math.PI / 1.4;
        scene.add( art7 );

        var art7labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art7labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000047-card.png' );
        ...
        var art8texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000386-full.jpg' );
        ...
        var art8labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000386-card.png' );
        ...
        var art9geometry = new THREE.CubeGeometry(40,53,1);
        var art9texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000092-full.jpg' );
        ...
        art9.position.set(40,23.8,-1250);
        art9.rotation.y = Math.PI / 1.4;
        scene.add( art9 );

        var art9labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art9labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000092-card.png' );
        ...
        var art10geometry = new THREE.CubeGeometry(40,48,1);
        var art10texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000007-full.jpg' );
        ...
        art10.position.set(-60,21,-1350);
        scene.add( art10 );

        var art10labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art10labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000007-card.png' );
        ...
        var art11texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000403-full.jpg' );
        ...
        art11.position.set(60,23.4,-1450);
        scene.add( art11 );

        var art11labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art11labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000403-card.png' );
        ...
        var art12texture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/art/jpg/CF000408-full.jpg' );
        ...
        art12.position.set(-40,23.4,-1550);
        art12.rotation.y = Math.PI / 3.2;
        scene.add( art12 );

        var art12labelgeometry = new THREE.CubeGeometry(40,16,1);
        var art12labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000408-card.png' );
        ...
        // var art13labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000173-card.png' );
        ...
        // var art14labeltexture = THREE.ImageUtils.loadTexture( 'https://centerfold-website.s3.amazonaws.com/assets/featured-collections/FC000002/CF000174-card.png' );
