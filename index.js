...
app.get('/featured-collections/FC000005-from-the-vault', function(req, res){
    var context = {title: "From the Vault", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
    ...
    getCollection('From the Vault').then(function(result) {
        var filterStatement = constructFilterStatement(result);
        getArtwork(filterStatement).then(function(result){
            context['homepageArtworks'] = result;
            getCollection('From the Vault').then(function(result){
                ...
                getArtwork(filterStatement).then(function(result){
                    ...
                    getArtists(artPageArtistsFilterStatement).then(function(result){
                        ...
                        res.render('featured-collections/FC000005.html', context);
                    });
                });
            });
        });
