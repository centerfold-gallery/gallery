...
app.get('/featured-collections/FC000004-parts-of-a-whole', function(req, res){
    ...
    getCollection('Parts of a Whole').then(function(result) {
        var filterStatement = constructFilterStatement(result);
        getArtwork(filterStatement).then(function(result){
            context['homepageArtworks'] = result;
            getCollection('Parts of a Whole').then(function(result){
                ...
                getArtwork(filterStatement).then(function(result){
                    ...
                    getArtists(artPageArtistsFilterStatement).then(function(result){
                        ...
                        res.render('featured-collections/FC000004.html', context);
                    });
                });
            });
        });
...
// Sales Pages (Price Sheets)

app.get('/private/real-ventures', function(req, res){
    var context = {title: "Real Ventures", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
    ...
    getCollection('Real Ventures').then(function(result) {
        var filterStatement = constructFilterStatement(result);
        getArtwork(filterStatement).then(function(result){
            context['homepageArtworks'] = result;
            getCollection('Real Ventures').then(function(result){
                ...
                getArtwork(filterStatement).then(function(result){
                    ...
                    getArtists(artPageArtistsFilterStatement).then(function(result){
                        ...
                        res.render('private-buy/options/price-sheet.html', context);
                    });
                });
            });
        });
