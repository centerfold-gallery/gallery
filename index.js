...
app.get('/search', function(req, res){
    var context = {title: "Search Results", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            ...
            getCollection('Art Page').then(function(result){
                ...
                getArtwork(filterStatement).then(function(result){
                    ...
                    getArtists(artPageArtistsFilterStatement).then(function(result){
                        ...
                        res.render('search/results.html', context);
                    });
                });
            });
        });
