module.exports = function(app) {
    ...
    app.get('/artists/hailey-anne-guzik', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Hailey Anne Guzik", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/zoe-boivin', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Zoé Boivin", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/heidi-cardyn', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Heidi Cardyn", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/nina-chabel', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Nina Chabel", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/madeleine-chevalier', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Madeleine Chevalier", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/kathryn-ciu-leci', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Kathryn Ciu Leci", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/emma-cross', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Emma Cross", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/heidi-daehler', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Heidi Daehler", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/polina-dmitrievna-stanevskaya', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Polina Dmitrievna Stanevskaya", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/erzulie', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Erzulie", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/catherine-fitri-prince', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Catherine Fitri Prince", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/victoria-gravel', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Victoria Gravel", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/alessandra-lontra', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Alessandra Lontra", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/sandra-morellato', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Sandra Morellato", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/jordann-murray', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Jordann Murray", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/maya-pathak', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Maya Pathak", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/zoe-pawlak', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Zoë Pawlak", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/claudia-rynkowski', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Claudia Rynkowski", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/nicole-small', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Nicole Small", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/jackie-stendel', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Jackie Stendel", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/connie-sutera', function(req, res){
            var Airtable = require('airtable');
            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
            var context = {title: "Connie Sutera", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
            var getCollection = function(title) {
                return new Promise(function(resolve, reject) {
                    base('Artists')
                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
    ...
    app.get('/artists/janna-yotte', function(req, res){
        ...
        app.get('/artists/jose-guillermo-garcia-sierra', function(req, res){
                var Airtable = require('airtable');
                var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                var context = {title: "Jose Guillermo Garcia Sierra", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                var getCollection = function(title) {
                    return new Promise(function(resolve, reject) {
                        base('Artists')
                            .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
            ...
            app.get('/artists/olivia-turchyniak', function(req, res){
                    var Airtable = require('airtable');
                    var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                    var context = {title: "Olivia Turchyniak", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                    var getCollection = function(title) {
                        return new Promise(function(resolve, reject) {
                            base('Artists')
                                .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                ...
                app.get('/artists/stefanie-auger-roy', function(req, res){
                        var Airtable = require('airtable');
                        var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                        var context = {title: "Stefanie Auger-Roy", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                        var getCollection = function(title) {
                            return new Promise(function(resolve, reject) {
                                base('Artists')
                                    .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                    ...
                    app.get('/artists/sara-leila-dumont', function(req, res){
                            var Airtable = require('airtable');
                            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                            var context = {title: "Sara-Leila Dumont", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                            var getCollection = function(title) {
                                return new Promise(function(resolve, reject) {
                                    base('Artists')
                                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                        ...
                        app.get('/artists/katherine-parthimos', function(req, res){
                            ...
                            app.get('/artists/mary-mulderry-macisaac', function(req, res){
                                    var Airtable = require('airtable');
                                    var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                                    var context = {title: "Mary Mulderry MacIsaac", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                                    var getCollection = function(title) {
                                        return new Promise(function(resolve, reject) {
                                            base('Artists')
                                                .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                                ...
                                app.get('/artists/zeesun-haque', function(req, res){
                                        var Airtable = require('airtable');
                                        var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                                        var context = {title: "Zeesun Haque", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                                        var getCollection = function(title) {
                                            return new Promise(function(resolve, reject) {
                                                base('Artists')
                                                    .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                                    ...
                                    app.get('/artists/mimi-owen', function(req, res){
                                            var Airtable = require('airtable');
                                            var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                                            var context = {title: "Mimi Owen", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                                            var getCollection = function(title) {
                                                return new Promise(function(resolve, reject) {
                                                    base('Artists')
                                                        .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
                                        ...
                                        app.get('/artists/david-durham', function(req, res){
                                                var Airtable = require('airtable');
                                                var base = new Airtable({apiKey: config.storageConfig.airtableAPIKey}).base(config.storageConfig.airtableBase);
                                                var context = {title: "David Durham", static_url: "https://s3.amazonaws.com/centerfold-website/", stripeAPIKey: config.storageConfig.stripeAPIKey};
                                                var getCollection = function(title) {
                                                    return new Promise(function(resolve, reject) {
                                                        base('Artists')
                                                            .select({view: "Grid view", filterByFormula: "{Full Name} = '"+ title +"'"})
